...
<!--              <span style="margin-top: 10px">评论区</span>-->
<!--              <p style="margin-top: 10px">评论区</p>-->
<!--            </div>-->
<!--            <el-button  round @click="dialogVisible = true">发表评论</el-button>-->
<!--          </div>-->
          <div>
...
import { getDialogVisible, getToken, setDialogVisible } from "@/api/auth";
import beforeLogin from "@/components/beforeLogin";
import afterLogin from "@/components/afterLogin";
import cot from "@/components/Comment";
const clickoutside = {
  // 初始化指令
